...
sys.modules['openenv.core.env_server'].Action = type('Action', (BaseModel,), {})
sys.modules['openenv.core.env_server'].Observation = type('Observation', (BaseModel,), {})
sys.modules['openenv.core.env_server'].State = type('State', (BaseModel,), {})
sys.modules['openenv.core.env_server'].Environment = type('Environment', (), {'_reset_rubric': lambda self: None})
